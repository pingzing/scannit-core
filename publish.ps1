...
$rewrittenMainToml = (Get-Content ./Cargo.toml) -replace $regex, "version = `"1.0.$env:BUILD_BUILDNUMBER";
...
$rewrittenFfiToml = (Get-Content ./scannit-core-ffi/Cargo.toml) -replace $regex, "version = `"1.0.$env:BUILD_BUILDNUMBER";
